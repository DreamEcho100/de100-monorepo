...
- Focused tests:
  - `apps/proto-cook-web/src/libs/server/media-storage.test.ts`
  - `apps/proto-cook-web/src/libs/auth-errors.test.ts`
  - `apps/proto-cook-web/src/libs/orpc-errors.test.ts`
  - `apps/proto-cook-web/src/libs/validation-errors.test.ts`
