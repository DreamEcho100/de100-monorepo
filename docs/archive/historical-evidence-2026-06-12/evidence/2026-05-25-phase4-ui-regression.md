...
- Runtime: local dev server (`pnpm -F @de100/apps-proto-cook-web dev --host 127.0.0.1 --port 3000`)
...
3. `/en/login` -> `/en/dashboard`
   - Signed in with seeded account `owner@proto-cook.test` to validate protected rendering path.
4. `/en/media`
