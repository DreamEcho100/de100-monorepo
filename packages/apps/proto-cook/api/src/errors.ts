import { appErrorDataSchema } from "@de100/apps-proto-cook-validators/server";
import type { AppErrorCode, AppErrorParams } from "@de100/apps-proto-cook-validators/shared";
