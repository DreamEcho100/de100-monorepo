...
export const protoCookFilesRouter = createFilesRouter({
	avatar: f({
		image: {
			access: "private",
			maxFileCount: 1,
...
export const protoCookFilesRouteConfig = extractFilesRouterConfig(protoCookFilesRouter);
