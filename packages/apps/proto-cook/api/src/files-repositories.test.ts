...
import {
	serializeProtoCookFileArtifactGroupRecord,
	serializeProtoCookFileArtifactRecord,
	serializeProtoCookFilePlaybackEventRecord,
	serializeProtoCookFilePlaybackSessionRecord,
	serializeProtoCookFileRecord,
	serializeProtoCookFileVariantRecord,
	serializeProtoCookProcessingJobRecord,
	serializeProtoCookUploadPartRecord,
	serializeProtoCookUploadSessionRecord,
} from "./files-repositories";

const now = new Date("2026-06-02T08:00:00.000Z");

describe("Proto Cook files repository serializers", () => {
	it("serializes file rows to the platform file record contract", () => {
		const record = serializeProtoCookFileRecord({
