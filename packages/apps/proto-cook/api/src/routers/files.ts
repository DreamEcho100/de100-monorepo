import { appErrorCodes } from "@de100/apps-proto-cook-validators/shared";
...
import { createProtoCookFilesOrpcHandlers } from "../files-orpc";
...
export const filesRouter = {
	abortUpload: protectedProcedure
		...
		.handler(async ({ context, input }) => {
			...
			const handlers = createProtoCookFilesOrpcHandlers({
