...
- [ ] pnpm -F @de100/apps-proto-cook-infra selfhost:health returns success.
- [ ] pnpm -F @de100/apps-proto-cook-infra selfhost:verify returns success.
- [ ] pnpm -F @de100/apps-proto-cook-infra selfhost:smoke:public returns success.
...
## Data And Files Checks

- [ ] Todo CRUD works for signed-in user.
- [ ] Files upload succeeds for configured driver.
- [ ] Public files read works.
- [ ] Private files read enforces auth and owner scope.
- [ ] Signed files URL issuance and access work before expiry.
