...
This guide maps Proto Cook self-host deployment to Hostinger VPS offerings.
...
- Files storage: S3-compatible object storage configured through APP_PROTO_COOK_FILES_S3_*
