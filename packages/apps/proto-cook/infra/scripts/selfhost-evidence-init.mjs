...
function printUsage() {
	console.log(
		"Usage: pnpm -F @de100/apps-proto-cook-infra selfhost:evidence:init -- [environment] [--dry-run] [--force]",
	);
	console.log("Examples:");
	console.log("  pnpm -F @de100/apps-proto-cook-infra selfhost:evidence:init -- staging");
	console.log(
		"  pnpm -F @de100/apps-proto-cook-infra selfhost:evidence:init -- production --dry-run",
	);
}
