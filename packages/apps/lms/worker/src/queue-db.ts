...
import { fileProcessingJobs } from "@de100/apps-lms-db/schema/files";
...
export type LmsFilesWorkerJobQueueStore = {
...
export function createLmsFilesDbPollingQueueAdapter(
	store: LmsFilesWorkerJobQueueStore,
	input: { now?: () => Date } = {},
): FilesQueueAdapter {
...
export function createLmsFilesDrizzleJobQueueStore(db: DbInstance): LmsFilesWorkerJobQueueStore {
	return {
