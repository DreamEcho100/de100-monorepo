...
- [ ] `pnpm -F @de100/apps-lms-infra selfhost:preflight` passes.
- [ ] `pnpm -F @de100/apps-lms-infra selfhost:health` passes against target URL.
- [ ] `pnpm -F @de100/apps-lms-infra selfhost:verify` passes.
