...
This guide maps LMS self-host deployment to Hetzner Cloud.
...
- Media storage: S3-compatible provider with APP*LMS_MEDIA_S3*\* values
...
- Monitor network egress if media traffic volume increases.
