export const enMessages = {
	about: {
		...
		lede: "The current app is meant to validate the platform slices before the full LMS product build starts: authentication, seeded local data, user-owned todos, and managed files flows.",
		metaTitle: "About",
		starterSlices: {
