...
export const arMessages: I18nTranslations = {
	about: {
		...
		lede: "يهدف التطبيق الحالي إلى التحقق من شرائح المنصة قبل بدء بناء منتج LMS الكامل: المصادقة والبيانات المحلية المولدة والمهام المملوكة للمستخدم وتدفقات الوسائط المُدارة.",
		metaTitle: "حول التطبيق",
		starterSlices: {
			auth: "مصادقة البريد الإلكتروني وكلمة المرور عبر Better Auth مع حسابات تجريبية جاهزة",
			media: "تدفقات وسائط مُدارة مع تأكيد المسودات وتنظيف يديره المالك",
	...
	media: {
		...
		sections: {
			...
			uploadDescription:
				"تعتمد هذه المسارات على ارتباطات وسائط وقت التشغيل. استخدم بيئة تشغيل توفّر هذه الارتباطات عند اختبار الرفع من البداية إلى النهاية.",
			uploadTitle: "رفع ملف",
		},
		status: {
