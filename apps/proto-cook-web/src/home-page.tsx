...
const demoAccounts = [
	{ descriptionKey: "home.accounts.owner", email: "owner@proto-cook.test" },
	{ descriptionKey: "home.accounts.viewer", email: "viewer@proto-cook.test" },
	{ descriptionKey: "home.accounts.empty", email: "empty@proto-cook.test" },
] as const;
